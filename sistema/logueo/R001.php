...
<div class="login-form">
    ...
    <form action="../../php/registro.php" method="post">
        ...
        <div class="form-group">
        	<input type="text" class="form-control" name="nombre_cliente" placeholder="Nombre de usuario" required="required">
        </div>
		<div class="form-group">
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="ruc" placeholder="RUC" required="required">
        </div> 
        <div class="form-group">
