...
<body>
<button type="button" class="btn btn-danger"><a href="../gerente/index.php">Volver <span class="glyphicon glyphicon-time"></span></button></a> 
<div class="login-form">
  
    <form action="../../php/guardar_funcionario.php" method="post">
		<p>
		<div class="avatar">
			<img src="../../imagenes/logo5.png" alt="Avatar">
		</div>
        <h2 class="text-center">Registro de Cuenta de funcionario</h2>   
